...
includeFile("../custom_scripts/screenplays/conversations/example_npc_conv_handler.lua")

-- John Johnson
includeFile("../custom_scripts/screenplays/npc/john_johnson.lua")
includeFile("../custom_scripts/screenplays/conversations/john_johnson_conv_handler.lua")
