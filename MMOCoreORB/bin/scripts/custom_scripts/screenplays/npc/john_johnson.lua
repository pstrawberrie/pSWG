...
function JohnJohnsonScreenPlay:spawnMobiles()
	...
	-- x = -136 (X coordinate on the planet)
	-- z = 28 (Z coordinate/height on the planet)
	-- y = -4728 (Y coordinate on the planet)
	...
	spawnMobile("corellia", "john_johnson", 300, -136, 28, -4728, 90, 0, "npc_sitting_ground")
end